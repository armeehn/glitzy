...
FFGAC = os.environ.get("GLITZY_FFGAC", "/opt/ffglitch/bin/ffgac")
FFEDIT = os.environ.get("GLITZY_FFEDIT", "/opt/ffglitch/bin/ffedit")
RACK_DIR = os.environ.get("GLITZY_RACK", "/opt/glitzy/rack")
